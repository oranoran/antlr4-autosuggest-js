...
const clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Lexer = require('./testGrammars/clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Lexer');
const clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Parser = require('./testGrammars/clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Parser');
...
describe('Autosuggest', function () {
    ...
    it('should handle grammar "clause: clause AND clause | action; action: \'action\'; AND: \'AND\';" with input "action AND"', function () {
        givenGrammar(clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Lexer.clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Lexer, clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Parser.clause_clauseANDclause_action_action__Q_action_Q__AND__Q_AND_Q_Parser);
        whenInput('action AND');
        thenExpect([]);
    });
